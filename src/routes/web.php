...
Route::group(['middleware' => 'basicauth'], function () {
    ...
    Route::delete('/api/temp-images/{tempImage}', [\App\Http\Controllers\Api\ImageController::class, 'destroy'])
        ->name('api.temp-images.destroy');
    ...
    Route::get('/api/series/{seriesId}', function ($seriesId) {
        return \App\Models\Series::with('category')->find($seriesId);
